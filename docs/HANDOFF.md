...
| 最近 session | `docs/sessions/2026-07-05-continued.md` |
| 实验数据 | `experiments/v0.7.0-grid-final/` + `v0.7.0-hex-baseline/` |
| Insights | `docs/journal/INSIGHTS.md` |
| **Rust 引擎** | `miniciv-core/` — `cd miniciv-core && cargo test` (68 tests) |
