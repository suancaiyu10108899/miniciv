...
**一阶深度阶段:硬伤全修复 + 甜点带(成本×2)确定,深化前探索完成。79 tests (+3 ignored)。**
...
> **修完重测→新甜点 = C线成本×2 + city_hp160**(非早期盯的×3): 建设↔军事↔防守**三方制衡、
> 有克制环**(骑兵>步兵78%/防守>骑兵53%)、无单一支配、征服43/建设47均衡、40-80T决出。
> 兵种机制完整后这是最健康的甜点(DECISIONS #18)。骑兵精调/地形等归深化阶段。
